/**
 * @license 3DViewer v1.0.0
 * (c) 2023 Diego Zazzeroni <zazze88@gmail.com>
 * License: MIT
 */

(function(g,f){typeof exports==='object'&&typeof module!=='undefined'?f(require('rxcomp'),require('rxcomp-form'),require('rxjs/operators'),require('agora-rtm-sdk'),require('rxjs'),require('three')):typeof define==='function'&&define.amd?define(['rxcomp','rxcomp-form','rxjs/operators','agora-rtm-sdk','rxjs','three'],f):(g=typeof globalThis!=='undefined'?globalThis:g||self,f(g.rxcomp,g.rxcomp.form,g.rxjs.operators,g.AgoraRTM,g.rxjs,g.THREE));})(this,(function(rxcomp,rxcompForm,operators,AgoraRTM,rxjs,THREE){'use strict';function _interopNamespace(e){if(e&&e.__esModule)return e;var n=Object.create(null);if(e){Object.keys(e).forEach(function(k){if(k!=='default'){var d=Object.getOwnPropertyDescriptor(e,k);Object.defineProperty(n,k,d.get?d:{enumerable:true,get:function(){return e[k]}});}})}n["default"]=e;return Object.freeze(n)}var THREE__namespace=/*#__PURE__*/_interopNamespace(THREE);function _defineProperties(target, props) {
...
['localhost', '127.0.0.1', '0.0.0.0'].indexOf(window.location.host.split(':')[0]) !== -1;var HttpService = /*#__PURE__*/function () {
...
var DropdownDirective = /*#__PURE__*/function (_Directive) {
  ...
  _proto.onClick = function onClick(event) {
    ...
    if (this.opened === null) {
      ...
      var dropdownItemNode = node.querySelector('[dropdown-item]');
...
class RGBELoader extends THREE.DataTextureLoader {
  ...
  RgbeLoader.loadRgbeBackground = function loadRgbeBackground(path, file, renderer, callback) {
    var pmremGenerator = new THREE__namespace.PMREMGenerator(renderer);
    pmremGenerator.compileEquirectangularShader();
    var loader = new RGBELoader();
    loader.setDataType(THREE__namespace.UnsignedByteType)
...
var Panorama = /*#__PURE__*/function () {
  ...
  _proto.create = function create() {
    var geometry = new THREE__namespace.SphereBufferGeometry(500, 60, 40);
    geometry.scale(-1, 1, 1);
    // const material = new THREE.MeshBasicMaterial();
    var material = new THREE__namespace.ShaderMaterial({
  ...
  _proto.loadRgbe = function loadRgbe(item, renderer, callback) {
    ...
    RgbeLoader.load(item, renderer, function (envMap, texture) {
      ...
      _this.mesh.material.uniforms.resolution.value = new THREE__namespace.Vector2(texture.width, texture.height);
  ...
  _proto.createScene = function createScene() {
    ...
    this.info = node.querySelector('.model-viewer__info');
    this.worldRect = Rect.fromNode(container);
    this.cameraRect = new Rect();
    var camera = this.camera = new THREE__namespace.PerspectiveCamera(45, container.offsetWidth / container.offsetHeight, 0.1, 1000);
    camera.position.set(0, 1, 3);
    camera.target = new THREE__namespace.Vector3();
    camera.lookAt(camera.target);
    var renderer = this.renderer = new THREE__namespace.WebGLRenderer({
      antialias: true,
      alpha: true,
    ...
    */
    ...
    this.drag$().pipe(operators.takeUntil(this.unsubscribe$)).subscribe(function (event) {
    ...
    var objects = this.objects = new THREE__namespace.Group();
    scene.add(objects);
    ...
    var light = new THREE__namespace.PointLight(0xffffff, 0.8);
    light.position.set(-50, 0, 0);
    scene.add(light);
    var light2 = new THREE__namespace.PointLight(0xffffff, 0.3);
    light2.position.set(50, 0, 0);
    scene.add(light2);
    var light3 = new THREE__namespace.PointLight(0xffffff, 0.5);
    light3.position.set(0, 50, 0);
    scene.add(light3);
    var light4 = new THREE__namespace.PointLight(0xffffff, 0.1);
    light4.position.set(0, -50, 0);
    scene.add(light4);
    var ambient = this.ambient = new THREE__namespace.AmbientLight(0xffffff, 0.25);
    scene.add(ambient);
    this.resize();
  };
  ...
  _proto.repos_ = function repos_(object, rect) {
    ...
    var cameraRect = this.cameraRect;
    var sx = rect.width / worldRect.width * cameraRect.width;
    rect.height / worldRect.height * cameraRect.height;
  ...
  _proto.repos = function repos(object, rect) {
    ...
    var ty = (rect.y + rect.height / 2 - worldRect.height / 2) / worldRect.height * 2.0 * this.camera.aspect;
    // console.log(tx);
...
var GEOMETRY = new THREE__namespace.BoxGeometry(1, 1, 1);
...
var ModelComponent = /*#__PURE__*/function (_Component) {
  ...
  _proto.onInit = function onInit() {
    ...
    this.scale = new THREE__namespace.Vector3(1.0, 1.0, 1.0);
    this.position = new THREE__namespace.Vector3();
    var group = this.group = new THREE__namespace.Group();
    group.renderOrder = 3;
  ...
  _proto.create = function create(callback) {
    var material = new THREE__namespace.MeshStandardMaterial({
      color: new THREE__namespace.Color('#ffcc00'),
      roughness: 0.4,
      metalness: 0.01,
      flatShading: true,
      transparent: true,
  ...
  _proto.getScroll = function getScroll(offset) {
    var scroll = this.intersection.scroll(offset);
    // console.log(scroll);
    return scroll;
  };
...
ModelComponent.meta = {
  ...
  _proto.createStand = function createStand() {
    var geometry = new THREE__namespace.BoxBufferGeometry(3, 3, 3);
    var material = new THREE__namespace.MeshBasicMaterial();
    /*
    ...
    */
    this.stand = new THREE__namespace.Mesh(geometry, material);
  };
  _proto.create = function create(callback) {
    var _this = this;
    this.loadGltfModel(BASE_HREF + environment.paths.models + this.item.gltfFolder, this.item.gltfFile, function (mesh) {
      ...
      // repos
      var dummy = new THREE__namespace.Group();
      dummy.add(mesh);
      box.setFromObject(dummy);
      var center = box.getCenter(new THREE__namespace.Vector3());
      dummy.position.set(mesh.position.x - center.x, mesh.position.y - center.y,
      // center
...
ModelGltfComponent.meta = {
  ...
  _proto.create = function create(callback) {
    var mesh = new THREE__namespace.Group();
    if (typeof callback === 'function') {
      callback(mesh);
    }
  }
    ...
    return DragService.events$(this.inner).pipe(operators.tap(function (event) {
      if (event instanceof DragDownEvent) {
        ...
        if (distanceX * -1 > width * 0.25 && _this2.hasNext()) {
          ...
          _this2.inner.style.transform = "translate3d(" + -100 * _this2.current + "%, 0, 0)";
